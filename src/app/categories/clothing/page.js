      ...
      <main className="flex-1">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ fontFamily: "Sugar, serif", color: "#5A0117" }}>
              Fashion & Clothing
            </h1>
            <p className="text-xl max-w-2xl mx-auto" style={{ fontFamily: "Montserrat, sans-serif", color: "#8C6141" }}>
                    ...
                    {totalPages > 1 && (
                      <div className="mt-12 flex justify-center items-center gap-4">
                        <button
                          ...
                          style={{
                            backgroundColor: currentPage === 1 ? '#E5E7EB' : '#8C6141',
                        ...
                        <div className="flex items-center gap-2">
                          <span className="px-4 py-2 rounded-lg font-bold text-white" style={{ backgroundColor: "#5A0117", fontFamily: "Montserrat, sans-serif" }}>
                            {currentPage}
                          </span>
                          <span className="text-gray-500" style={{ fontFamily: "Montserrat, sans-serif" }}>of {totalPages}</span>
                        </div>
                        ...
                        <button
                          ...
                          className="px-6 py-3 rounded-lg font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-105"
                          style={{
                            backgroundColor: currentPage === totalPages ? '#E5E7EB' : '#8C6141',
